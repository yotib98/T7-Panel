...
body.purple-mode {
  --primary:#a855f7; --primary-dim:rgba(168,85,247,0.15);
  --bg:#0a0a0a; --bg2:#1a1a2e; --bg3:#1f1a2e;
  --surface:rgba(26,26,46,0.85); --surface2:rgba(30,30,50,0.9); --surface3:rgba(40,35,60,0.8);
  --border:rgba(168,85,247,0.15); --border2:rgba(168,85,247,0.3);
  --text:#e2d9f0; --text2:#a894c0; --text3:#7a6a8a;
}
body.pink-mode {
  --primary:#ec4899; --primary-dim:rgba(236,72,153,0.15);
  --bg:#0a0a0a; --bg2:#1a0a1a; --bg3:#2a1020;
  --surface:rgba(26,10,26,0.85); --surface2:rgba(40,15,35,0.9); --surface3:rgba(50,20,40,0.8);
  --border:rgba(236,72,153,0.15); --border2:rgba(236,72,153,0.3);
  --text:#f0d0e0; --text2:#c090b0; --text3:#906070;
}
body.orange-mode {
  --primary:#f59e0b; --primary-dim:rgba(245,158,11,0.15);
  --bg:#0a0a0a; --bg2:#1a100a; --bg3:#2a1a0a;
  --surface:rgba(26,16,10,0.85); --surface2:rgba(40,25,15,0.9); --surface3:rgba(50,30,15,0.8);
  --border:rgba(245,158,11,0.15); --border2:rgba(245,158,11,0.3);
  --text:#f0e0d0; --text2:#c0a080; --text3:#907060;
}
      ...
      <div class="card">
        ...
        <div class="fg">
          ...
          <div class="glass-btn-group" id="theme-glass-group">
            ...
            <button type="button" class="glass-btn" id="btn-theme-blue" onclick="setPanelTheme('blue')">Blue</button>
            <button type="button" class="glass-btn" id="btn-theme-purple" onclick="setPanelTheme('purple')">Purple</button>
            <button type="button" class="glass-btn" id="btn-theme-pink" onclick="setPanelTheme('pink')">Pink</button>
            <button type="button" class="glass-btn" id="btn-theme-orange" onclick="setPanelTheme('orange')">Orange</button>
          </div>
...
const footerTexts = {
  en: 'Dedicated to the people of my homeland Iran',
  fa: 'تقدیم به مردم سرزمینم ایران'
};
...
function setTheme(t){
  ...
  document.body.classList.toggle('blue-mode',t==='blue');
  document.body.classList.toggle('purple-mode',t==='purple');
  document.body.classList.toggle('pink-mode',t==='pink');
  document.body.classList.toggle('orange-mode',t==='orange');
  localStorage.setItem('theme',t);
  const iconMap = { 'dark':'🌙', 'light':'☀️', 'blue':'🌊', 'purple':'🟣', 'pink':'🌸', 'orange':'🟠' };
  document.querySelector('.btn-icon').textContent=iconMap[t] || '🌙';
  updChartColors();
  syncGlassThemeButtons();
}
function toggleTheme(){
  const themes=['dark','light','blue','purple','pink','orange'];
